...
public class MECRepPerson extends SherlockActivity {
        ...
        AlpaDataBaseHelper mdbh = new AlpaDataBaseHelper(this.getApplicationContext());
         ...
         //  myImage.setImageBitmap(bmp); 
	 		...
	 		final TextView tv2 = (TextView)findViewById(R.id.RepPos);
	 		 tv2.setText(cursor.getString(cursor.getColumnIndex("Position")) + " " + cursor.getString(cursor.getColumnIndex("Unit")));
	 		
	 		TextView tv6 = (TextView)findViewById(R.id.RepBlock);
	 		tv6.setText( "Block: " + cursor.getString(cursor.getColumnIndex("Block")) + " Rep");
