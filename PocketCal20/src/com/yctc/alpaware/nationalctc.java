...
public class nationalctc extends SherlockActivity {
    ...
    public void onCreate(Bundle Icicle) {
     ...
     int names[] = {android.R.id.text1,android.R.id.text2};
 		Cursor c = db.rawQuery("Select _id, Email,Department from ALPANational",null);		  
  ...
  lv.setOnItemClickListener( new AdapterView.OnItemClickListener() {
 	public void onItemClick(AdapterView<?> parent, View v, int position, long id)
 	{
 		...
 		Bundle b = new Bundle();
 		b.putLong("pID", id);
 		Intent myIntent = new Intent(getBaseContext(), nationalctcdetail.class);
