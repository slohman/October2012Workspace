...
public class explistbycity extends SherlockActivity{
    ...
    public void onCreate(Bundle Icicle) {
        ...
        setContentView(R.layout.explistbycity); //use same XML format
        
        
        Bundle b = this.getIntent().getExtras();  
        String srchCity = b.getString("dID");
     ...
     int names[] = {android.R.id.text1,android.R.id.text2};
 		final Cursor c = db.rawQuery("Select _id, exp_CITY, exp_AMT, exp_AMT ||'    '|| exp_DATE ||'   '|| exp_CAT ||'   ' || exp_COMM AS EXPCITY from EXP where exp_CITY LIKE '" + srchCity  +  "%' order by exp_Date ASC" ,null);		  
	    ...
	    grandtotal = Float.toString(totalamount);
	 	TextView ttl = (TextView)findViewById(R.id.footer1);
