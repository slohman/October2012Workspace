...
public class expreports extends SherlockActivity{

	
		@Override
	    public void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.expreports);
		...
		Button r1 = (Button) findViewById(R.id.expbydate);
	    r1.setOnClickListener(new View.OnClickListener() {
	    	public void onClick(View view) {
	  	      ...
	  	      fl.addView(input, new FrameLayout.LayoutParams(FrameLayout.LayoutParams.FILL_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT));
	  	           ...
	  	           Builder b =  new AlertDialog.Builder(expreports.this);
	  	           b.setView(fl);
	  	     ...
	  	     b.setPositiveButton("OK", new DialogInterface.OnClickListener(){
	  	    	 	public void onClick(DialogInterface d, int which) {
	  	    	 		...
	  	    	 		Intent myIntent = new Intent(getBaseContext(), explistbydate.class);
	    ...
	    r2.setOnClickListener(new View.OnClickListener() {
	    	public void onClick(View view) {
	  	      ...
	  	      input.setText("");
	  	      fl.addView(input, new FrameLayout.LayoutParams(FrameLayout.LayoutParams.FILL_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT));
	  	      input.setHint("Enter City 3 Letter ID");
	  	     ...
	  	     b.setPositiveButton("OK", new DialogInterface.OnClickListener(){
	  	    	 	public void onClick(DialogInterface d, int which) {
	  	    	 		d.dismiss();
	  	    	 		// get date and execute SQL here....
	  	    	 		String repCity = input.getText().toString();
	  	    	 		Bundle bun = new Bundle();
	  	      			bun.putCharSequence("dID", repCity);
