...
public class ieresponse extends SherlockActivity {
    ...
    public void onCreate(Bundle Icicle) {
     ...
     int names[] = {android.R.id.text1,android.R.id.text2};
 		Cursor c = db.rawQuery("Select rowid, Country, Medical ||' ' || Fire || ' ' || Police AS svcs from IntEmer where type =" + 3,null);		  
  ...
  lv.setOnItemClickListener( new AdapterView.OnItemClickListener() {
 	public void onItemClick(AdapterView<?> parent, View v, int position, long id)
 	{
 		...
 		Bundle b = new Bundle();
 		b.putLong("pID", id);
 		Intent myIntent = new Intent(getBaseContext(), ieresponsedetail.class);
